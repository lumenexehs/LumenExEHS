...
const articleContent = {
  ...
  "radon-ontario": {
    ...
    problemSnapshot: "Radon is a colourless, odourless radioactive gas that rises from bedrock and accumulates in lower floors. It is the second leading cause of lung cancer in Canada — and the vast majority of Ontario buildings have never been tested.",
    happening: [
      "Radon is naturally occurring uranium decay product — no workplace is automatically 'safe'",
      "Ontario's geology means elevated radon in many regions, including parts of the GTA",
      "Health Canada guideline: 200 Bq/m³ — above this, action is required",
      "Long-term exposure at elevated levels significantly increases lung cancer risk",
      "Federal and provincial workplaces have different regulatory triggers",
    ],
    whenToAct: [
      "Your building has never had a radon test",
      "You have workers in basement or ground-floor spaces",
      "A tenant or employee has raised a radon concern",
      "You are preparing a building for sale or occupancy change",
      "You are renewing an OHS program and want to address all risks",
    ],
    approach: "We conduct long-term radon measurements (minimum 90 days, per Health Canada protocol) using calibrated electret ion chambers or alpha-track detectors. Results are interpreted against Canadian guidelines and a remediation pathway (sub-slab depressurization, ventilation) is recommended where needed.",
    service: "radon",
  },
