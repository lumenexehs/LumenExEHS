    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69851d4d33bc1cfaaa36d43f/434dcad8c_ChatGPTImageMar4202612_50_13PM.png" alt="" className="w-full h-full object-contain bg-[#0F2A4A]" />
