...
const services = [
  ...
  },
  {
    ...
    risk: "Heat strain and MSD injury increase progressively with unmanaged exposure. Ontario's general duty clause applies regardless of temperature regulations.",
    action: "Structured thermal and ergonomic monitoring clarifies risk levels and guides control priorities.",
  ...
  },
  {
    ...
    risk: "Outdated programs may not meet current OHSA requirements and can undermine due diligence defence.",
  ...
  },
  {
    ...
    risk: "Gaps in worker and supervisor competency increase incident likelihood and regulatory exposure.",
    action: "Competency-based training and sector-specific assessment address identified gaps with measurable outcomes.",
