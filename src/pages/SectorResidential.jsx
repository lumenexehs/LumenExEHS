...
const icons = [MessageSquare, Wind, Radio, AlertTriangle, Building2];

export default function SectorResidential() {
  const { lang } = useLang();
  const tr = t[lang].sectorResidential;
    ...
    <div className="min-h-screen bg-white">
      <section className="relative bg-[#0F2A4A] pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 right-10 w-80 h-80 bg-teal-400 rounded-full blur-3xl" />
        </div>
